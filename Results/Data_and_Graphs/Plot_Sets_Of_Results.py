...
trainer.visualise_set_of_preexisting_results(results_data_paths=["Data_and_Graphs/Cart_Pole_Results_Data.pkl",
                                                                 "Data_and_Graphs/Mountain_Car_Results_Data.pkl"],
                                             plot_titles=["Cart Pole (Discrete Actions)", "Mountain Car (Continuous Actions)"],
                                             save_image_path="Data_and_Graphs/CartPole_and_MountainCar_Graph.png")
