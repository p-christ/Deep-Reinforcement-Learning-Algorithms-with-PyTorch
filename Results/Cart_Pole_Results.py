...
config.num_episodes_to_run = 40
config.file_to_save_data_results =  "testing.pkl" #"/Data_and_Graphs/Cart_Pole_Results_Data.pkl"
config.file_to_save_results_graph = "testing.png" # "/Data_and_Graphs/Cart_Pole_Results_Graph.png"
...
if __name__ == "__main__":
    ...
    AGENTS = [DDQN_Agent, PPO_Agent] #,  DQN_Agent_With_Fixed_Q_Targets, DDQN_With_Prioritised_Experience_Replay, DQN_Agent,\
